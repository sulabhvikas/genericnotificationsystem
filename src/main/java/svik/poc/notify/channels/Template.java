...
public class Template {
	...
	public Template(String templateId) throws Exception{
		ROOT_TEMPLATE_DIRECTORY = "/Users/sulabhvikas/project_home/notification/templates";
	...
	public String readTemplate(String templateId, String channel) throws IOException{
		
		String templateFilePath = ROOT_TEMPLATE_DIRECTORY + "/" + channel +"/"+ templateId + ".template";
